...
int main(int argc, char *argv[])
{
   ...
   c:	1800                	addi	s0,sp,48
    if (argc <= 1)
   e:	4785                	li	a5,1
  10:	04a7d263          	bge	a5,a0,54 <main+0x54>
  14:	84aa                	mv	s1,a0
  16:	892e                	mv	s2,a1
    {
  ...
  1e:	1f0080e7          	jalr	496(ra) # 20a <atoi>
  22:	89aa                	mv	s3,a0
    int pid = -1;
    if (argc >= 3)
  24:	4789                	li	a5,2
  ...
  26:	55fd                	li	a1,-1
    if (argc >= 3)
  28:	0497c363          	blt	a5,s1,6e <main+0x6e>
    {
        pid = atoi(argv[2]);
    }
  ...
  32:	38e080e7          	jalr	910(ra) # 3bc <va2pa>
    printf("0x%x\n", va);
  36:	0005059b          	sext.w	a1,a0
  3a:	00001517          	auipc	a0,0x1
  3e:	83e50513          	addi	a0,a0,-1986 # 878 <malloc+0x11a>
  42:	00000097          	auipc	ra,0x0
  46:	664080e7          	jalr	1636(ra) # 6a6 <printf>
    
    exit(0);
  4a:	4501                	li	a0,0
  4c:	00000097          	auipc	ra,0x0
  50:	2b8080e7          	jalr	696(ra) # 304 <exit>
        printf("Usage: vatopa virtual_address [pid]");
  54:	00000517          	auipc	a0,0x0
  58:	7fc50513          	addi	a0,a0,2044 # 850 <malloc+0xf2>
  5c:	00000097          	auipc	ra,0x0
  60:	64a080e7          	jalr	1610(ra) # 6a6 <printf>
        exit(1);
  64:	4505                	li	a0,1
  66:	00000097          	auipc	ra,0x0
  6a:	29e080e7          	jalr	670(ra) # 304 <exit>
        pid = atoi(argv[2]);
  6e:	01093503          	ld	a0,16(s2)
  72:	00000097          	auipc	ra,0x0
  76:	198080e7          	jalr	408(ra) # 20a <atoi>
  7a:	85aa                	mv	a1,a0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 414:	4d050513          	addi	a0,a0,1232 # 8e0 <digits>
 418:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d4:	3b8c8c93          	addi	s9,s9,952 # 888 <malloc+0x12a>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
 4d8:	02800d93          	li	s11,40
  putc(fd, 'x');
 4dc:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 4de:	00000b97          	auipc	s7,0x0
 4e2:	402b8b93          	addi	s7,s7,1026 # 8e0 <digits>
 4e6:	a839                	j	504 <vprintf+0x6a>
        putc(fd, c);
 4e8:	85ca                	mv	a1,s2
 4ea:	8556                	mv	a0,s5
 4ec:	00000097          	auipc	ra,0x0
 4f0:	ee0080e7          	jalr	-288(ra) # 3cc <putc>
 4f4:	a019                	j	4fa <vprintf+0x60>
    } else if(state == '%'){
 4f6:	01498d63          	beq	s3,s4,510 <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
 4fa:	0485                	addi	s1,s1,1
 4fc:	fff4c903          	lbu	s2,-1(s1)
 500:	14090d63          	beqz	s2,65a <vprintf+0x1c0>
    if(state == 0){
 504:	fe0999e3          	bnez	s3,4f6 <vprintf+0x5c>
      if(c == '%'){
 508:	ff4910e3          	bne	s2,s4,4e8 <vprintf+0x4e>
        state = '%';
 50c:	89d2                	mv	s3,s4
 50e:	b7f5                	j	4fa <vprintf+0x60>
      if(c == 'd'){
 510:	11490c63          	beq	s2,s4,628 <vprintf+0x18e>
 514:	f9d9079b          	addiw	a5,s2,-99
 518:	0ff7f793          	zext.b	a5,a5
 51c:	10fc6e63          	bltu	s8,a5,638 <vprintf+0x19e>
 520:	f9d9079b          	addiw	a5,s2,-99
 524:	0ff7f713          	zext.b	a4,a5
 528:	10ec6863          	bltu	s8,a4,638 <vprintf+0x19e>
 ...
 54a:	ea8080e7          	jalr	-344(ra) # 3ee <printint>
 54e:	8b4a                	mv	s6,s2
      } else {
 ...
 566:	e8c080e7          	jalr	-372(ra) # 3ee <printint>
 56a:	8b4a                	mv	s6,s2
      state = 0;
 56c:	4981                	li	s3,0
 ...
 582:	e70080e7          	jalr	-400(ra) # 3ee <printint>
 586:	8b4a                	mv	s6,s2
      state = 0;
 588:	4981                	li	s3,0
 ...
 5a2:	e2e080e7          	jalr	-466(ra) # 3cc <putc>
  putc(fd, 'x');
 5a6:	07800593          	li	a1,120
 5aa:	8556                	mv	a0,s5
 5ac:	00000097          	auipc	ra,0x0
 5b0:	e20080e7          	jalr	-480(ra) # 3cc <putc>
 5b4:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 5c6:	e0a080e7          	jalr	-502(ra) # 3cc <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 5ca:	0992                	slli	s3,s3,0x4
 5cc:	397d                	addiw	s2,s2,-1
 5ce:	fe0914e3          	bnez	s2,5b6 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
 5d2:	f8843b03          	ld	s6,-120(s0)
      state = 0;
 5d6:	4981                	li	s3,0
 5d8:	b70d                	j	4fa <vprintf+0x60>
        s = va_arg(ap, char*);
 5da:	008b0913          	addi	s2,s6,8
 5de:	000b3983          	ld	s3,0(s6)
        if(s == 0)
 5e2:	02098163          	beqz	s3,604 <vprintf+0x16a>
        while(*s != 0){
 5e6:	0009c583          	lbu	a1,0(s3)
 5ea:	c5ad                	beqz	a1,654 <vprintf+0x1ba>
          putc(fd, *s);
 5ec:	8556                	mv	a0,s5
 5ee:	00000097          	auipc	ra,0x0
 5f2:	dde080e7          	jalr	-546(ra) # 3cc <putc>
          s++;
 5f6:	0985                	addi	s3,s3,1
        while(*s != 0){
 5f8:	0009c583          	lbu	a1,0(s3)
 5fc:	f9e5                	bnez	a1,5ec <vprintf+0x152>
        s = va_arg(ap, char*);
 5fe:	8b4a                	mv	s6,s2
      state = 0;
 600:	4981                	li	s3,0
 602:	bde5                	j	4fa <vprintf+0x60>
          s = "(null)";
 604:	00000997          	auipc	s3,0x0
 608:	27c98993          	addi	s3,s3,636 # 880 <malloc+0x122>
        while(*s != 0){
 60c:	85ee                	mv	a1,s11
 60e:	bff9                	j	5ec <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
 610:	008b0913          	addi	s2,s6,8
 614:	000b4583          	lbu	a1,0(s6)
 618:	8556                	mv	a0,s5
 61a:	00000097          	auipc	ra,0x0
 61e:	db2080e7          	jalr	-590(ra) # 3cc <putc>
 622:	8b4a                	mv	s6,s2
      state = 0;
 624:	4981                	li	s3,0
 626:	bdd1                	j	4fa <vprintf+0x60>
        putc(fd, c);
 628:	85d2                	mv	a1,s4
 62a:	8556                	mv	a0,s5
 ...
 64c:	d84080e7          	jalr	-636(ra) # 3cc <putc>
      state = 0;
 650:	4981                	li	s3,0
...
malloc(uint nbytes)
{
 ...
 838:	b58080e7          	jalr	-1192(ra) # 38c <sbrk>
  if(p == (char*)-1)
